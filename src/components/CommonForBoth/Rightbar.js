        ...
        <SimpleBar style={{ height: "900px" }}>
          <div data-simplebar className="h-100">
            ...
            <div className="p-4">
              ...
              <div className="mb-2">
                <Link to="//uza-v-light.react.themesbrand.com" target="_blank">
                  <img
                    src={layout1}
              ...
              <div className="mb-2">
                <Link to="//uza-v-dark.react.themesbrand.com" target="_blank">
                  <img
                    src={layout2}
                    className="img-fluid img-thumbnail"
                    alt=""
              ...
              <div className="mb-2">
                <Link to="//uza-v-rtl.react.themesbrand.com" target="_blank">
                  <img
                    src={layout3}
                    className="img-fluid img-thumbnail"
                    alt=""
