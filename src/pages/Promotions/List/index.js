      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            ...
            breadcrumbItems={[{ title: SLUGS_NAME.confiLogistics===props.settings?.slug ? props.t("promos"): props.t("promotions") }]}
          />
                                ...
                                <div className="text-sm-left text-md-right">
                                  {accesses.canAdd && (
                                    <Button
                                      ...
                                      onClick={() =>
                                        history.push("/promotions/add")
                                      }
                                    >
                                      <i className="mdi mdi-plus mr-1" />
                                      {SLUGS_NAME.confiLogistics===props.settings?.slug?props.t("add_promos"):  props.t("add_promotion")}
                                    </Button>
                                  )}
                                </div>
                              </Col>
...
const mapStateToProps = ({ Settings, promotions }) => ({
  settings: Settings.settings,
  loading: promotions.loading,
  promotions: promotions.promotions,
  totalPromotions: promotions.totalPromotions,
})

const mapDispatchToProps = dispatch => ({
  onGetPromotions: data => dispatch(getPromotions(data)),
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(withTranslation()(Promotions))
)
