    ...
    >
      ...
      <div className="modal-body">
        <Row>
          ...
          <Col md={6}>
            <FormGroup>
              <Label>{props.t("Transfer By")}</Label>

              <p>{details?.PaymentBy?.name}</p>
            </FormGroup>
          </Col>
          <Col md={6}>
            <FormGroup>
            ...
            details?.storeType?.storeType && (
              <Col md={6}>
                {["TAXI", "PICKUPDROP"].includes(
                  details?.storeType?.storeType?.toUpperCase()
                ) ? (
                  <Link
                    to={`/${details?.storeType?.storeType?.toLowerCase()}/trip/${
                      details?.order
                    }/profile`}
                  ...
                  <Link
                    to={`/${details?.storeType?.storeType?.toLowerCase()}/orders/${
                      details?.order
                    }/profile`}
                    className="waves-effect waves-light p-0 font-size-15"
                  >
