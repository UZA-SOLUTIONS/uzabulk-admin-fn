...
const mapDispatchToProps = dispatch => ({
  onGetFdCategory: (id) => dispatch(getFdCategory('storeType', id)),
  onAddFdCategory: (data, history) =>
    dispatch(addFdCategory('storeType', data, history)),
  onPutFdCategory: (data, history) =>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(withTranslation()(AddEditCategory))
)
