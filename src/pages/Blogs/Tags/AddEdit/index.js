...
const mapDispatchToProps = dispatch => ({
  onGetCustomer: id => dispatch(getblogTag(id)),
  onAddCustomer: (data, history) => dispatch(addblogTag(data, history)),
  onPutCustomer: (customer, history) => dispatch(putBlogTag(customer, history)),
