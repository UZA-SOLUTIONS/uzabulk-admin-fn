    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Customers"
            breadcrumbItem={props.t("blog_tag")}
            breadcrumbItems={[
              {
                title: props.t("blog_tag"),
                link: "/blog-tag",
              },
            ]}
          />
...
const mapStateToProps = ({ Settings, BlogTag }) => ({
  settings: Settings.settings,
  loading: BlogTag.loading,
  customers: BlogTag.blogTags,
  totalCustomers: BlogTag.totalblogTag,
})

const mapDispatchToProps = dispatch => ({
  getCustomersSuccess: data => dispatch(getblogTagsSuccess(data)),
  onGetCustomers: data => dispatch(getblogTags(data)),
  onDeleteCustomer: (data, callback) => dispatch(deleteBlogTag(data, callback)),
  onPutCustomersStatus: (data, callback) =>
    dispatch(putBlogTagsStatus(data, callback)),
})
