...
const Customers = props => {
  ...
  const handleClick = () => {
    history.push("/blog-category/add")
  }
    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="Customers"
            breadcrumbItem={props.t("blog_category")}
            breadcrumbItems={[
              {
...
const mapStateToProps = ({ Settings, BlogCategory }) => ({
  settings: Settings.settings,
  loading: BlogCategory.loading,
  customers: BlogCategory.blogCategories,
  totalCustomers: BlogCategory.totalblogCategory,
})

const mapDispatchToProps = dispatch => ({
  getCustomersSuccess: data => dispatch(getblogCategoriesSuccess(data)),
  onGetCustomers: data => dispatch(getblogCategories(data)),
  onDeleteCustomer: (data, callback) =>
    dispatch(deleteBlogCategory(data, callback)),
  onPutCustomersStatus: (data, callback) =>
    dispatch(putBlogCategoriesStatus(data, callback)),
})
