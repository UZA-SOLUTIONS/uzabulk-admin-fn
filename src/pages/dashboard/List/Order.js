...
const Dispatcher = ({
  ...
  return (
    <React.Fragment>
      <Card>
        <CardBody>
          <CardTitle>{props?.t("recent_order")}</CardTitle>
          ...
          <PaginationProvider pagination={paginationFactory(pageOptions)}>
            {({ paginationProps, paginationTableProps }) => (
              <ToolkitProvider
                ...
                data={disputeList || []}
                columns={ListColumns({
                  currentUrl: disputeList?.storeType?.storeType?.toLowerCase(),
                  t: props.t,
                  setid,
              ...
              >
                {toolkitProps => (
                  <React.Fragment>
                    <Row>
                      <Col className="mb-3" xs={12} md={7} lg={8} xl={7}>
