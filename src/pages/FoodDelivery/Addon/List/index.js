...
import { getFdAddons, deleteFdAddon, putFdAddonsStatus } from "store/actions"
...
const FdAddons = ({
  ...
  // console.log(hasPermission("STORE.addon.CREATE"), "hshhshsh")
      ...
      <div className="page-content">
        <Container fluid>
          ...
          {!["serviceprovider", "carrental", "airbnb"].includes(
            ...
            <p>
              <small>
                Add-On is the extra Ingredients Customers can add into their
                dish at the time of order can be defined here..
              </small>
            </p>
          )}
                    ...
                    {({ paginationProps, paginationTableProps }) => (
                      <ToolkitProvider
                        ...
                        columns={ListColumns({
                          ...
                          accesses,
                          t: props.t,
                          hasPermission: hasPermission("STORE.addon.DELETE"),
                                  ...
                                  {accesses.canAdd &&
                                    hasPermission("STORE.addon.CREATE") && (
                                      <Button
                                        ...
                                        onClick={() =>
                                          history.push(
                                            `/${activeStoreType?.storeType?.toLowerCase()}/add-on/add${
                                              !!_vendorIdParam
                                                ? "/" + vendorIdParam
                                                : ""
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(withTranslation()(FdAddons))
)
