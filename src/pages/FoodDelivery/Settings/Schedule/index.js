...
const TimeSlot = props => {
  const { activeStoreType, fields, handleChange, _STORE_SETTINGS_FORM } = props

  return (
    <Row>
      <Col lg={4}>
        <Instructions t={props.t} _STORE_SETTINGS_FORM={_STORE_SETTINGS_FORM} />
      </Col>
      ...
      <Col lg={8}>
        <Form>
          <Row>
            <Col md={6}>
              <FormGroup>
                <Label className="text-capitalize">{props.t("schedule")}</Label>
