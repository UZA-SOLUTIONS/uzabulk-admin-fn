...
const TimeSlot = props => {
  ...
  // console.log(props?.settings?.storeType, "rrrrshowHideCommisionOnDeliveryType")
  return (
    <Row>
      <Col lg={4}>
        <Instructions
          isServicep={activeStoreType?.storeType}
          t={props.t}
            ...
            <FormGroup>
              {showHideCommisionOnDeliveryType &&
                [
                  ...
                  "LEQUQR",
                  "CAR RENTAL",
                ].includes(props?.settings?.storeType) && (
          ...
          <Row>
            ...
            <Col md={4}>
              <FormGroup>
                ...
                <InputGroup>
                  <Input
                    id="formrow-per_product-input"
                    type="number"
                    value={fields?.per_product || 0}
                    onChange={e => {
                      const { value } = e.target

                      if (value > 100) return
                      handleChange("per_product")(e)
                    }}
                    min={0}
                    step={0.01}
                  />
                  ...
                  <label>
                    ...
                    <InputGroup>
                      <Input
                        ...
                        onChange={e => CommissionChange(e, "delivery")}
                      />
                    ...
                    <FormText>
                      {`${
                        100 -
                        stateCommission.commissionOnDeliveryType.delivery.vendor
                  ...
                  <label>
                    ...
                    <InputGroup>
                      <Input
                        ...
                        onChange={e => CommissionChange(e, "takeway")}
                      />
                    ...
                    <FormText>
                      {`${
                        100 -
                        stateCommission.commissionOnDeliveryType.takeway.vendor
                      }%   ${props.t("admin_commission")}`}
                    </FormText>
                  </label>
                </Col>
