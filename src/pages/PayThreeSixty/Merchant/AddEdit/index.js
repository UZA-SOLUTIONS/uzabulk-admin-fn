...
import { addFdAttribute, addMerchant, getFdAttribute, putFdAttribute } from "store/actions"
                ...
                <Form onSubmit={onSubmit} className="spinner-content">
                    ...
                    <Row>
                        ...
                        <Col md={6}>
                            <FormGroup>
                                <Label htmlFor="formrow-firstname-Input">
                                    {props.t("isvName")}<span className="text-danger ml-1">*</span>
                                </Label>
                                <Input
                                    type="text"
                        ...
                        <Col md={6}>
                            <FormGroup>
                                <Label htmlFor="formrow-firstname-Input">
                                    {props.t("first_name")}<span className="text-danger ml-1">*</span>
                                </Label>
                                <Input
                                    type="text"
                                    className="form-control"
                    ...
                    <Row>
                        <Col md={6}>
                            <FormGroup>
                                <Label htmlFor="formrow-firstname-Input">
                                    {props.t("last_name")}<span className="text-danger ml-1">*</span>
                                </Label>
                                <Input
                                    type="text"
                                    className="form-control"
                        ...
                        <Col md={6}>
                            <FormGroup>
                                <Label htmlFor="formrow-firstname-Input">
                                    {props.t("email_address")}<span className="text-danger ml-1">*</span>
                                </Label>
                                <Input
                                    type="text"
                                    className="form-control"
                    ...
                    <Row>
                        <Col md={6}>
                            <FormGroup>
                                <Label htmlFor="formrow-firstname-Input">
                                    {props.t("phone_number")}<span className="text-danger ml-1">*</span>
                                </Label>
                                <Input
                                    type="text"
                                    className="form-control"
                        ...
                        <Col md={6}>
                            <FormGroup>
                                <Label htmlFor="formrow-firstname-Input">
                                    {props.t("business_classification")}<span className="text-danger ml-1">*</span>
                                </Label>
                                <Input
                                    type="text"
                                    className="form-control"
                                    id="formrow-firstname-Input"
                                    // value={fields.name || ""}
                                    onChange={handleChange("businessClassification")}
                                    required
                                />
                            </FormGroup>
                        </Col>
                        ...
                        <Col sm={10} lg={8}>
                            <Breadcrumbs
                                ...
                                breadcrumbItems={[
                                    ...
                                    {
                                        title: props.t("MerchantList"),
                                        link: '/settings/pay360merchant'
                                    },
                                    {
                                        title: props.t("Add"),
                                    },
...
const mapDispatchToProps = dispatch => ({
    ...
    onAddMerchant: (data, callback) => dispatch(addMerchant(data, callback))
})

export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(withTranslation()(AddMerchant))
)
