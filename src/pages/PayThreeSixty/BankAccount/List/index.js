...
import { getFdAddons, deleteFdAddon, putFdAddonsStatus, getBankAccount } from "store/actions"
    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          ...
          />
          {activeStoreType?.storeType?.toLowerCase() !== "serviceprovider" &&
            <p>
              <small>
                Add Pay360 Bank Account
              </small>
            </p>
          }
...
const mapStateToProps = ({ Login, FD_Addons, Settings }) => ({
  ...
  settings: Settings,
  bankAccount: Settings?.bankAccounts
})
...
const mapDispatchToProps = dispatch => ({
  ...
  ongetBankAccount: () => dispatch(getBankAccount())
})

export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(withTranslation()(BankAccount))
)
