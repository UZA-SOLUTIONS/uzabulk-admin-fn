  ...
  return (
    ...
    >
      <div className="modal-content">
        <ModalBody>
          <h3>
            {props.t("import")} {props.t("customers")}
          </h3>
          ...
          >
            ...
            <FormGroup>
              ...
              <FormText>
                <a
                  href={`${props.import_user}`}
                  target="_blank"
                  download="customers-format.csv"
                >
...
const mapStateToProps = ({ Login, customers }) => ({
  import_user: Login.importCSV?.import_user,
  error: customers.importError,
  success: customers.importSuccess,
})
