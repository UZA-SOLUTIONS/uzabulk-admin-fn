...
import {
  uploadFile,
  postFdCustomerDocument as postFdDriverDocument,
  getFdCustomerDocument as getFdDriverDocument,
  putFdCustomerDocument as putFdDriverDocument,
} from "store/actions"
                  ...
                  <Form onSubmit={onSubmit} className="spinner-content">
                    ...
                    <Row>
                      {fields?.fields?.map((item, index) => {
                        ...
                        var dangerTag = item.name ===
                          "license-exp-date-pjruokyoki" &&
                          (!!item.value
                            ? moment(item?.value, "DD-MMM-YYYY")
                            : moment()
...
const mapStateToProps = ({ customers: FD_Drivers, Login }) => ({
