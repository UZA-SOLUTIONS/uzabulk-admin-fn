...
const Customers = props => {
  ...
  const handleClick = () => {
    if (role !== "VENDOR") {
      history.push("/sub-admins/add")
    } else {
      history.push(`/${lowerCaseStoreType}/sub-admins/add`)
    }
  }
        ...
        <Container fluid>
          <Breadcrumbs
            ...
            breadcrumbItem={props.t(
              role !== "VENDOR" ? "sub_admins" : "sub_vendar"
            )}
            breadcrumbItems={[
              {
                title: props.t(role !== "VENDOR" ? "sub_admins" : "sub_vendar"),
                link: "/sub-admins",
              },
            ]}
          />
