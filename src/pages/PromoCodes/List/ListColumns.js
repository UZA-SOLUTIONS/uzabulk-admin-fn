...
const ListColumns = ({
  ...
  },
  {
    ...
    sort: true,
    formatter: (_, row) => moment(row.start_date).format("DD MMM YYYY"),
  },
  {
    text: t("expires"),
    dataField: "date_expires",
    sort: true,
    formatter: (_, row) => moment(row.date_expires).format("DD MMM YYYY"),
  },
  {
    isDummyField: true,
    text: t("action"),
    ...
    formatter: (_, row) => (
      <>
        <Link
          to={`/${storeTypeParam}/promo-codes/${row._id}/edit${
