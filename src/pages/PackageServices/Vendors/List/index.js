...
import {
  deletePackageServiceVendor as deletePromoCode,
  putPromoCodesStatus,
  getPackageServiceVendorList as getPromoCodes,
} from "store/actions"
...
const List = ({
  ...
  const { list: promoCodes, listCount: totalPromoCodes } = PackageServiceVendor
...
const mapDispatchToProps = dispatch => ({
  ...
  getPackageServiceVendorList: payload =>
    dispatch(getPackageServiceVendorList(payload)),
})

export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(withTranslation()(List))
)
